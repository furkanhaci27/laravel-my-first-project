                ...
                <div class="topbar-left">
                    <a href="#" class="logo">
                        <span class="logo-light">
                                <i class="mdi mdi-camera-control"></i> hd.com
                            </span>
                        <span class="logo-sm">
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                  ...
                                  <input type="text" name="adi" class="form-control" placeholder="Kişi adı Soyadı">
                                  ...
                                  <input type="email" name="email" class="form-control" placeholder="Kişi Mail Adresi">
                                  ...
                                  <input type="text" name="adresi" class="form-control" placeholder="Kişi Adresi">
