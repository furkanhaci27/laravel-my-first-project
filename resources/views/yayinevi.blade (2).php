                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="rehberhakkinda">Rehber Hakkında</a></li>
                                    <li><a href="faydalıbilgiler">Faydalı Bilgiler</a></li>
                                    <li><a href="tanıtım">Tanıtım</a></li>
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="card">
                                    <div class="card-heading p-4">
                                        ...
                                        <div>
                                            <h5 class="font-16">Reber Kayıt Sayısı</h5>
                                        </div>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Gaziantep şahinbey akpınar mahalle</td>
                                                        <td>12/15/2021</td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td>Mustafa</td>
                                                        <td><span class="badge badge-warning">çevri</span></td>
                                                        <td>$3,120,000</td>
                                                        <td>
                                                            <div>
                                                        ...
                                                        <td>Gaziantep şahinbey kaleboynu mahalle</td>
                                                        <td>12/15/2021</td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        <td>Ahmet</td>
                                                        <td><span class="badge badge-success">yazılım</span></td>
                                                        <td>$6,360,000</td>
                                                        <td>
                                                            <div>
                                                        ...
                                                        <td>Gaziantep şahinbey burç mahallesi</td>
                                                        <td>12/15/2021</td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Gaziantep şahinbey Belen köy mahallesi</td>
                                                        <td>19/1/2021</td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
