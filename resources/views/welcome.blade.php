    ...
    <!-- Begin page -->
        <div id="wrapper">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="/" class="waves-effect">
                                    <i class="icon-accelerator"></i><span class="badge badge-success badge-pill float-right">9+</span> <span> Giriş Sayfası
                                     </span>
                                </a>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="kisilistesi">Kişi Listesi</a></li>
                                    <li><a href="kisiekle">Kişi Ekle</a></li>
                                    <li><a href="kisibul">Kişi Bul</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="#">Rehber Hakkında</a></li>
            ...
            <div class="content-page">
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div class="card">
                                    <div class="card-heading p-4">
                                        ...
                                        <div>
                                            <h5 class="font-16">Rehber Kayıt Sayısı</h5>
                                        </div>
                                        <h3 class="mt-4">12355512</h3>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title mb-4">Son 5 Kayıt</h4>
                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" colspan="2">Doğum Tarihi</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>0532 631 29 56</td>
                                                        <td>
                                                            <div>
                                                                <img src="assets/images/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> hacı@gmail.com
                                                            </div>
                                                        </td>
                                                        <td>gaziantep şahinbey belenköy no67</td>
                                                        <td>15/01/2006</td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td>Abdusamet kaya</td>
                                                        <td><span class="badge badge-danger">çevrimdışı</span></td>
                                                        <td>0534 521 70 01</td>
                                                        <td>
                                                            <div>
                                                                <img src="assets/images/user-6.jpg" alt="" class="thumb-md rounded-circle mr-2"> abdulsamet@gmail.com
                                                            </div>
                                                        </td>
                                                        <td>gaziantep şahinbey burç mah.16065 nolu sokak</td>
                                                        <td>19/07/2006</td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        <td>Ege bademoğlu</td>
                                                        <td><span class="badge badge-success">Aktif</span></td>
                                                        <td>0542 563 52 81</td>
                                                        <td>
                                                            <div>
                                                                <img src="assets/images/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> ege@gmail.com
                                                            </div>
                                                        </td>
                                                        <td>gaziantep şahinbey kaleboynu no43</td>
                                                        <td>17/01/2006</td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        <td>Mustafa özbal</td>
                                                        <td><span class="badge badge-danger">çevrimdışı</span></td>
                                                        <td>0531 331 31 31</td>
                                                        <td>
                                                            <div>
                                                                <img src="assets/images/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> mustafa@gmail.com
                                                            </div>
                                                        </td>
                                                        <td>gaziantep şahinbey kaleboynu no43</td>
                                                        <td>18/01/2006</td>
                                                    ...
                                                    <tr>
                                                        <td>ibrahim durna</td>
                                                        <td><span class="badge badge-success">Aktif</span></td>
                                                        <td>0542 162 51 32</td>
                                                        <td>
                                                            <div>
                                                                <img src="assets/images/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> ibrahim@gmail.com
                                                            </div>
                                                        </td>
                                                        <td>gaziantep şahinbey gülpınar mah. ertuğrul sokak no1</td>
                                                        <td>19/01/2006</td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                ...
                <!-- content -->
                <footer class="footer">
                    ©2021 furkan.com <span class="d-none d-sm-inline-block"> - Love <i class="mdi mdi-heart text-danger"></i> by HD.com</span>.
                </footer>
            </div>
            <!-- ============================================================== -->
